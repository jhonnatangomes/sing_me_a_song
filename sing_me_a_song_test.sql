...
SELECT pg_catalog.setval('public.genres_id_seq', 4905, true);
...
SELECT pg_catalog.setval('public.recommendations_genres_id_seq', 2262, true);
...
SELECT pg_catalog.setval('public.recommendations_id_seq', 3121, true);
